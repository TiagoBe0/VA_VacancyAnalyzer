...
class ClusterProcessor:
    ...
    def compute_max_distance(self, data):
        ...
        """
        # Suponiendo que data.particles.positions es un array NumPy de forma (N, 3)
    ...
    def run_training(self, ids_file, output_training_file):
        ...
        vacancias = []
        vecinos = []
        max_distancias = []  # Vector para almacenar la mayor distancia al centro de masa
        min_distancias = []  # Vector para almacenar la menor distancia al centro de masa
        
        for index in range(len(total_ids)):
            # Se seleccionan los primeros (index+1) IDs para eliminar
            ...
            # Calcular la mayor y menor distancia al centro de masa para los datos de data_3
            ...
            # Contar el número de partículas restantes
        ...
        print(f"Los resultados se han exportado a '{output_training_file}'.")